...
proposicoes.find_element_by_xpath('//*[@id="so-api"]/div/div/section[2]/a/div/h2').click()
proposicoes.find_element_by_xpath('//*[@id="operations-Proposições-searchUsingGET_2"]/div/div').click()
proposicoes.find_element_by_xpath('//*[@id="operations-Proposições-searchUsingGET_2"]/div[2]/div/div[2]/div[1]/div[2]/button').click()
proposicoes.find_element_by_xpath('//*[@id="operations-Proposições-searchUsingGET_2"]/div[2]/div/div[2]/div[2]/table/tbody/tr[2]/td[2]/div[2]/button').click()
proposicoes.find_element_by_xpath('//*[@id="operations-Proposições-searchUsingGET_2"]/div[2]/div/div[2]/div[2]/table/tbody/tr[2]/td[2]/div[2]/div/input').send_keys('PEC')
proposicoes.find_element_by_xpath('//*[@id="operations-Proposições-searchUsingGET_2"]/div[2]/div/div[2]/div[2]/table/tbody/tr[2]/td[2]/div[2]/button').click()
proposicoes.find_element_by_xpath('//*[@id="operations-Proposições-searchUsingGET_2"]/div[2]/div/div[2]/div[2]/table/tbody/tr[2]/td[2]/div[2]/div[2]/input').send_keys('PLP')
proposicoes.find_element_by_xpath('//*[@id="operations-Proposições-searchUsingGET_2"]/div[2]/div/div[2]/div[2]/table/tbody/tr[2]/td[2]/div[2]/button').click()
proposicoes.find_element_by_xpath('//*[@id="operations-Proposições-searchUsingGET_2"]/div[2]/div/div[2]/div[2]/table/tbody/tr[2]/td[2]/div[2]/div[3]/input').send_keys('PL')
proposicoes.find_element_by_xpath('//*[@id="operations-Proposições-searchUsingGET_2"]/div[2]/div/div[2]/div[2]/table/tbody/tr[12]/td[2]/input').send_keys('2021-09-21')
proposicoes.find_element_by_xpath('//*[@id="operations-Proposições-searchUsingGET_2"]/div[2]/div/div[2]/div[2]/table/tbody/tr[13]/td[2]/input').send_keys('2021-09-24')
proposicoes.find_element_by_xpath('//*[@id="operations-Proposições-searchUsingGET_2"]/div[2]/div/div[3]/button').click()

proposicoes.current_url

# PARTE 2
# Extração e tratamento de dados

url = 'https://dadosabertos.camara.leg.br/api/v2/proposicoes?siglaTipo=PEC&siglaTipo=PLP&siglaTipo=PL&dataInicio=2021-09-21&dataFim=2021-09-24&ordem=ASC&ordenarPor=id'
...
pframe = pd.DataFrame.from_dict(pdict)
pframe
